"""
Django settings for chatbot_web_version project.
...
SECRET_KEY = 'django-insecure-mhu3zdfe-7$^pmsq%fs#is_nzvh&=67k6i%4v#rnim$5yv^wc7'
...
WSGI_APPLICATION = 'chatbot_web_version.wsgi.application'
